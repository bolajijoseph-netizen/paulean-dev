        ...
        <div className="scard-body">
          <div className="toggle-row" style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
            <div className="toggle-info">
              ...
              <div className="toggle-desc">Paulean will see work calendar events and ask before acting on work-related tasks. Some tasks 鈥?like scheduling, research, and email follow-ups 鈥?can be handled automatically.</div>
            </div>
